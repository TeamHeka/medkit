...
TEST_PARAMS_CONFIG = [
    ...
    (
        SPECIAL_CHARS_RULES,
        "Temp 34 °C + 32 °F. Ignore this 23°5. Also this : © ® ™ …",
        "Temp 34 Celsius + 32 Fahrenheit. Ignore this 23 5. Also this :    ",
        [
            Span(start=0, end=8),
            ModifiedSpan(length=7, replaced_spans=[Span(start=8, end=10)]),
            Span(start=10, end=16),
            ModifiedSpan(length=10, replaced_spans=[Span(start=16, end=18)]),
            Span(start=18, end=34),
            ModifiedSpan(length=1, replaced_spans=[Span(start=34, end=35)]),
            Span(start=35, end=50),
