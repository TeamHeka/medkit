...
def test_intermediate_operation():
    ...
    generator = Generator(builder)
    prefixer_1 = Prefixer(builder)
    prefixer_2 = Prefixer(builder)
    input_items = generator.generate(2)
...
def test_partial_provenance():
    ...
    generator = Generator(prov_builder=None)
    splitter = Splitter(prov_builder=None)
    merger = Merger(builder)
    input_items = generator.generate(2)
    split_items = splitter.split(input_items)
