...
from medkit.core import dict_serializable, serialize, deserialize
...
class TranscribedDocument(TextDocument):
    ...
    @classmethod
    def from_dict(cls, doc_dict: Dict[str, Any]) -> TranscribedDocument:
        """
        ...
        anns = [deserialize(d) for d in doc_dict.get("annotations", [])]
        return cls(
            uid=doc_dict["uid"],
            text=doc_dict["text"],
