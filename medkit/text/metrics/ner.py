...
class SeqEvalEvaluator:
    """Evaluator that use seqeval to compute the performance of labelisation tasks
    such as named-entity recognition. This evaluator compares TextDocuments of reference
    ...
    def __init__(
        ...
        ----------
        tokenizer:
            A fast HuggingFace tokenizer to convert text into tokens
        tagging_scheme:
